<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        //index.phpは自分自身のことを指しているが、POSTの内容をクリアするために記述する。
...
<div id="wrap">
    ...
    <div id="content">
        ...
        <?php $stmt = $db->prepare('select p.id, p.member_id, p.message, p.created, m.name, m.picture
        from posts p, members m where p.member_id=m.id order by id desc');
        if(!$stmt){
            die($db->error);
        }
